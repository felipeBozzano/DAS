...
EXEC Comenzar_Federacion @id_plataforma = 2, @id_cliente = 12, @codigo_de_transaccion = "Codigo1_Cliente1_Plataforma1",
...
EXEC Finalizar_Federacion @id_plataforma = 2, @id_cliente = 12, @token = "Token1_Cliente1_Plataforma1";
...
/* INICIAR FEDERACION DE CLIENTE 1 CON PLATAFORMA 3 */
EXEC Comenzar_Federacion @id_plataforma = 3, @id_cliente = 1, @codigo_de_transaccion = "Codigo3_Cliente1_Plataforma3",
     @tipo_transaccion = 'L', @url_login_registro_plataforma = 'https://www.plataforma3.com/login',
     @url_redireccion_propia = 'https://www.streamingstudio.com/terminarfederacion';
EXEC Finalizar_Federacion @id_plataforma = 3, @id_cliente = 1, @token = "Token3_Cliente1_Plataforma3";
...
EXEC Comenzar_Federacion @id_plataforma = 2, @id_cliente = 4, @codigo_de_transaccion = "Codigo1_Cliente4_Plataforma2",
     @tipo_transaccion = 'R', @url_login_registro_plataforma = 'https://www.plataforma3.com/registro',
     @url_redireccion_propia = 'https://www.streamingstudio.com/terminarfederacion';
...
EXEC Comenzar_Federacion @id_plataforma = 1, @id_cliente = 5, @codigo_de_transaccion = "Codigo1_Cliente5_Plataforma1",
     @tipo_transaccion = 'L', @url_login_registro_plataforma = 'https://www.plataforma3.com/login',
     @url_redireccion_propia = 'https://www.streamingstudio.com/terminarfederacion';
EXEC Finalizar_Federacion @id_plataforma = 1, @id_cliente = 5, @token = "Token2_Cliente5_Plataforma1";

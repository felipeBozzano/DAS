...
EXEC Comenzar_Federacion @id_plataforma = 3, @id_cliente = 12, @codigo_de_transaccion = "Codigo1_Cliente1_Plataforma1",
...
EXEC Finalizar_Federacion @id_plataforma = 3, @id_cliente = 12, @token = "Token1_Cliente1_Plataforma1";

...
public interface IReproducirContenidoRepository {
    ContenidoUrlBean obtener_url_de_contenido(String id_contenido, int id_plataforma, int id_cliente) throws ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException;
